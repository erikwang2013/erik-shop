...
<p align="center">
  <img src="../../pet.svg" width="180" alt="Snowy — تميمة مشروع Erik Shop">
</p>

## تميمة المشروع — Snowy

تميمة المشروع هي **Snowy** — روح كروية ترتدي تاجًا من ندفة الثلج وتغطيها خطوط الطول، تحتضن طردًا عابرًا للحدود. ترمز ندفة الثلج إلى معرّفات Snowflake الموزّعة، والكرة الأرضية إلى التجارة العابرة للحدود، والطرد إلى الخدمات اللوجستية الدولية. الشرح الكامل: [README بالصينية](../../../README.md#项目宠物--雪球-snowy).
