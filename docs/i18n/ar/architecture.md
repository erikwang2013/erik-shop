...
- **قاطع الدائرة/تدهور الخدمة**: قاطع دائرة Redis — استدعاءات API الخارجية (بوابات الدفع/تسجيل الدخول الاجتماعي): 5 إخفاقات متتالية → كسر الدائرة 30 ثانية، اختبار شبه مفتوح مع استعادة تلقائية؛ أخطاء الأعمال لا تُحتسب كفشل؛ عند تعطل Redis السماح بالمرور تلقائيًا (503)
