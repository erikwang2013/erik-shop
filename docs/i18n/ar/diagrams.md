...
| الطبقة الثالثة | التحكم في الحركة | RateLimitMiddleware + عداد القوة الغاشمة في Redis | تحديد المعدل بدلو الرموز (6 نقاط) + حماية تسجيل الدخول/التسجيل من القوة الغاشمة |
...
| 7 | مخطط البنية الأمنية | مخطط بنية | عرض نظام الدفاع العميق المكون من 6 طبقات: الحدود → WAF → الحركة → المصادقة → البيانات → الاستجابة |
