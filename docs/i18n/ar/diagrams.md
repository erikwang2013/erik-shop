...
| 6 | مخطط بنية النشر | مخطط بنية | عرض حافة CDN وتنظيم حاويات Docker Compose والشبكة وأحجام البيانات (بما فيها أحجام الرفع المستمرة admin_uploads / service_public) |
