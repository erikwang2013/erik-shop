...
### 4.2 Redis-এর ব্যবহার

Redis রেট লিমিট টোকেন বাকেট (`support\Redis` ফ্যাসাড), হিউম্যান ভেরিফিকেশন কোড ও Session স্টোরেজে ব্যবহৃত হয়; বিজনেস ডেটা অ্যাপ্লিকেশন-লেভেল ক্যাশ করা হয় না, সরাসরি MySQL থেকে পড়া হয় (রিড-রাইট সেপারেশন + কানেকশন পুল)।
