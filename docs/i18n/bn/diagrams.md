...
| তৃতীয় স্তর | ট্রাফিক কন্ট্রোল | RateLimitMiddleware + ব্রুট ফোর্স Redis কাউন্টার | টোকেন বাকেট রেট লিমিট (6 এন্ডপয়েন্ট) + লগইন/রেজিস্ট্রেশন অ্যান্টি-ব্রুট ফোর্স |
...
| ৬ | ডিপ্লয়মেন্ট আর্কিটেকচার ডায়াগ্রাম | আর্কিটেকচার ডায়াগ্রাম | Docker Compose কনটেইনার অর্কেস্ট্রেশন, নেটওয়ার্ক, ডেটা ভলিউম |
| ৭ | নিরাপত্তা আর্কিটেকচার ডায়াগ্রাম | আর্কিটেকচার ডায়াগ্রাম | 6 স্তরের ডিফেন্স-ইন-ডেপথ সিস্টেম: বাউন্ডারি→WAF→ট্রাফিক→অথেনটিকেশন→ডেটা→রেসপন্স |
