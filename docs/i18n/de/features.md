...
| **Hohe Nebenläufigkeit** | Token-Bucket-Limiting (Sliding-Window + 6 Endpunkt-Regeln), Circuit Breaker (Zahlung/Social-Login, 5 Fehler → 30s geöffnet + halboffene Erholung), DB-Read/Write-Splitting (2 Lesereplikate + sticky), Verbindungspool (DB 50/10 + Redis 30/5), OPCache (128MB, Docker-Umgebung) | Vollständig |
