...
| **High Concurrency** | Token bucket rate limiting, DB read/write split, connection pool optimization |
...
| [Architecture Design Document](../../architecture-full.md) | System architecture, middleware pipeline, data architecture, security architecture, payment architecture |
...
| [Deployment Documentation](../../deployment.md) | Docker/manual deployment, environment variables, operations commands |
