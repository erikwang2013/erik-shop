...
<p align="center">
  <img src="../../pet.svg" width="180" alt="Snowy — Erik Shop परियोजना शुभंकर">
</p>

## परियोजना शुभंकर — Snowy

परियोजना का शुभंकर **Snowy** है — बर्फ़ के फूल का मुकुट पहने और देशांतर-रेखाओं से ढका एक ग्लोब-स्प्राइट, जो सीमा-पार पार्सल को थामे हुए है। बर्फ़ का फूल Snowflake वितरित ID, ग्लोब सीमा-पार वाणिज्य और पार्सल अंतर्राष्ट्रीय लॉजिस्टिक्स को दर्शाता है। पूरा विवरण: [चीनी README](../../../README.md#项目宠物--雪球-snowy)।
...
> यह आरेख 19 प्रमुख फ़ीचर मॉड्यूल (रिपोर्ट सेंटर और प्लेटफ़ॉर्म आँकड़े सहित) को कवर करता है।
...
ब्राउज़र में `http://127.0.0.1:8788/app/admin` खोलकर प्रशासन पैनल में लॉगिन करें (पहली बार इंस्टॉलेशन विज़ार्ड से व्यवस्थापक खाता बनाएं):

- **डैशबोर्ड**: GMV, ऑर्डर मात्रा, उपयोगकर्ता वृद्धि जैसे प्रमुख मेट्रिक्स एक नज़र में
- **रिपोर्ट सेंटर**: बिक्री सारांश, 30-दिन का रुझान, TOP उत्पाद, भुगतान विधि / ऑर्डर स्थिति वितरण
- उत्पाद, ऑर्डर, मार्केटिंग, आपूर्ति श्रृंखला आदि मॉड्यूल का दैनिक प्रबंधन
...
# होमपेज प्लेटफ़ॉर्म आँकड़े (उपयोगकर्ता/उत्पाद/ऑर्डर/GMV कुल और आज की नई संख्या)
curl http://127.0.0.1:8787/
```

> API संस्करण `API-Version` हेडर से दिया जाता है (URL में नहीं); संवेदनशील एंडपॉइंट्स के लिए `Authorization: Bearer <token>` (JWT) आवश्यक है।

### क्लाइंट

- **Flutter क्लाइंट**: `apps/flutter/` (iOS / Android / macOS / Windows / Linux)
- **HarmonyOS क्लाइंट**: `apps/harmonyos/` (HarmonyOS NEXT, ArkTS + ArkUI)
...
shop-php/
  ...
  admin/            प्रशासन पैनल (webman-admin)      — 83 कंट्रोलर + 76 मॉडल + ECharts डैशबोर्ड + Web इंस्टॉलेशन विज़ार्ड
...
| **रिपोर्ट विश्लेषण** | एडमिन रिपोर्ट सेंटर: बिक्री सारांश, 30-दिन का रुझान, TOP उत्पाद, भुगतान विधि / ऑर्डर स्थिति वितरण |
| **प्लेटफ़ॉर्म आँकड़े** | service होमपेज आँकड़े: उपयोगकर्ता/उत्पाद/ऑर्डर/GMV कुल और आज की नई संख्या |
