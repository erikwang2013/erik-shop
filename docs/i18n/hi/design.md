...
Redis का उपयोग रेट लिमिट टोकन बकेट (`support\Redis` फेसडे), मानव-सत्यापन कोड और Session स्टोरेज के लिए होता है; व्यावसायिक डेटा पर एप्लिकेशन-लेयर कैश नहीं किया जाता, सीधे MySQL से पढ़ा जाता है (रीड/राइट स्प्लिटिंग + कनेक्शन पूल)। इसके अलावा Redis से एडमिन पैनल से service तक CDN ग्लोबल ऑन/ऑफ स्थिति प्रचारित होती है (शेयर्ड कुंजी, prefix `shop:`, TTL 60s)।
