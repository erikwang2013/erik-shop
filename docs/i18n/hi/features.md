...
| **उच्च समवर्ती** | टोकन बकेट रेट लिमिट (स्लाइडिंग विंडो + 6 एंडपॉइंट नियम), सर्किट ब्रेकर (पेमेंट/सोशल लॉगिन, 5 विफलताएँ→30s मेल्ट डाउन + हाफ-ओपन रिकवरी), DB रीड/राइट स्प्लिटिंग (2 रीड रेप्लिका + sticky), कनेक्शन पूल (DB 50/10 + Redis 30/5), OPCache (128MB, Docker वातावरण) | पूर्ण |
