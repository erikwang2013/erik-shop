...
| **Konkurensi tinggi** | Rate limiting token bucket (jendela geser + 6 aturan endpoint), pemisahan baca/tulis DB (2 replika baca + sticky), kumpulan koneksi (DB 50/10 + Redis 30/5), OPCache (128MB, lingkungan Docker) | Lengkap |
