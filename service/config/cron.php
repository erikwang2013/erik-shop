...
return [
    ...
    // 物流轨迹查询 API 模板（{tracking_no} 占位符），需与 shop_logistics_companies.api_key 配合；env TRACKING_API_URL 可空
    ...
    // 平台订单同步 API 模板（{account_id} 占位符），需与 shop_platform_accounts.api_key 配合；env PLATFORM_SYNC_URL 可空
